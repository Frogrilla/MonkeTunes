...
namespace MonkeTunes.Music
{
    ...
    internal class MusicPlayer : MonoBehaviour
    {
        ...
        private async void Start()
        {
            ...
            text.transform.parent = GameObject.Find("JukeBox/screen").transform;
        ...
        public bool Playing
        {
            ...
            set
            {
                if (value)
                {
                    ...
                    GameObject.Find("JukeBox/play/icon_play").SetActive(true);
                    GameObject.Find("JukeBox/play/icon_pause").SetActive(false);
                }
                else
                {
                    ...
                    GameObject.Find("JukeBox/play/icon_play").SetActive(false);
                    GameObject.Find("JukeBox/play/icon_pause").SetActive(true);
                }
                Redraw();
            }
        }
